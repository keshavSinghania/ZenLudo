...
    { _id: "1", name: "Alice", username: "alice123", profilePic: defaultAvatar },
    { _id: "2", name: "Bob", username: "bob456", profilePic: defaultAvatar },
    { _id: "3", name: "Charlie", username: "charlie789", profilePic: defaultAvatar },
    { _id: "4", name: "Dave", username: "dave101", profilePic: defaultAvatar },
    { _id: "5", name: "Eve", username: "eve202", profilePic: defaultAvatar },
    { _id: "6", name: "Frank", username: "frank303", profilePic: defaultAvatar },
    { _id: "7", name: "Grace", username: "grace404", profilePic: defaultAvatar },
    { _id: "8", name: "Heidi", username: "heidi505", profilePic: defaultAvatar },
  ];

  return (
    <div className="relative w-full h-full bg-gray-950 text-white">
      {/* Backgrounds (now uses 'absolute' to stay within its container) */}
...
                  <button className="px-5 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full hover:scale-105 transition shadow-md font-semibold text-sm">
                    Add Friend
                  </button>
                </div>
              </div>
...
          )}
        </div>
        {/* The missing closing div tag was here. All good now! */}
        {/* ------------------- FRIEND REQUESTS ------------------- */}
        <div className="w-full max-w-2xl">
...
                <button className="px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full text-sm font-semibold hover:scale-105 transition transform shadow-md">
                  Accept
                </button>
                <button className="px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 rounded-full text-sm font-semibold hover:scale-105 transition transform shadow-md">
                  Reject
                </button>
              </div>
            </div>

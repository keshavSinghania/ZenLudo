...
import { acceptFriendRequestController, fetchFriendRequestsController, fetchFriendsController, rejectFriendRequestController, searchFriendController, sendFriendRequestController } from "../controller/friend.controller.js";
...
friendRouter.post('/reject-friend-request',authVerifyMiddleware, rejectFriendRequestController);
friendRouter.get('/fetch-friends',authVerifyMiddleware, fetchFriendsController);